...
<main>
          ...
          <div class="col-xl-3 col-lg-4 col-md-12">
            <div class="row">
              <div class="col-xl-12 col-lg-12 col-md-6 col-sm-6">
                <div class="single-gallery mb-30">
                  <div class="gallery-img small-img" style="background-image: url({{asset('FrontEnd/Assets/img/gallery/gallery3.png')}});">
                  </div>
                </div>
              </div>
              <div class="col-xl-12 col-lg-12  col-md-6 col-sm-6">
                <div class="single-gallery mb-30">
                  <div class="gallery-img small-img" style="background-image: url({{asset('FrontEnd/Assets/img/gallery/gallery4.png')}});">
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="popular-items section-padding30" id="Latest-Items">
      <div class="container">
